...
class ConfigStorageByStream(Model):
...
#TODO : There should be a provision to inherit ActionField and ConfigField  from Field
class ConfigField(models.Model):
    # associated sensor
    source = models.ForeignKey(Sensor,
                               to_field='sourceKey',
                               related_name = "configfields",
                               related_query_name="configfield",
    ...
    type = models.CharField(max_length=10, blank=False, default='config')
