...
from helpdesk.models import EscalationExclusion, EmailTemplate, KBItem, SLADefinition
from helpdesk.models import TicketChange, Attachment, IgnoreEmail, TicketAssociation, BaseEventAssociation, \
    AlarmAssociation, AnalyticsAssociation
...
admin.site.register(TicketAssociation)
admin.site.register(SLADefinition)
admin.site.register(BaseEventAssociation)
admin.site.register(AlarmAssociation)
admin.site.register(AnalyticsAssociation)
