...
function inverters_ajbs() {
  ...
  $.ajax({
        ...
        success: function(data) {
            ...
            var connection, button_color, connection_status, connection_text_color_status, group_name, group_name_class, solar_status, total_ajbs_down, ajbs_down_number, total_ajbs_down_class, errors, errors_hide;
        ...
        success: function(data) {
          if(data.ajbs.length) {
            ...
            for(var i = 0; i < data.ajbs.length; i++) {
              ...
              $("#ajbs_grid").append('<div class="element-item col-lg-3 col-md-3 col-sm-12 col-xs-12 panel grey_panel" data-category="' + data.ajbs[i].connected + '" id="ajb_'+i+'" style="border: 3px solid white;">' +
      '<div class="row">' + 
